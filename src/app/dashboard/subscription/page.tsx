        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          {!user?.stripe_subscription_id ? (
            <div className="text-center py-6">
              ...
              <div className="mt-6">
                <Link href="https://buy.stripe.com/dR66pbesred64Qo288" className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Start Free Trial
                </Link>
              </div>
            </div>
