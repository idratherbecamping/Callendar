      ...
      <ScrollAnimation animationClass="slide-up">
        <section className="py-24 gradient-bg-dark relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-0 right-0 w-96 h-96 bg-green-500 rounded-full filter blur-3xl opacity-10 animate-pulse"></div>
            <div className="absolute bottom-0 left-0 w-80 h-80 bg-blue-500 rounded-full filter blur-3xl opacity-10 animate-pulse"></div>
          </div>
          ...
          <div className="beesly-container relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-8">
                ...
                See how it handles booking, answers questions, and sounds completely natural.
              </p>
            </div>
            
            {/* Phone number highlight */}
            <div className="max-w-2xl mx-auto">
              <div className="glass-morphism-dark rounded-3xl p-8 md:p-12 border border-green-500/20 text-center">
                ...
                <p className="text-gray-400 mb-8">
                  This is a real AI receptionist answering calls 24/7. Try booking an appointment, 
                  ask questions about services, or just see how natural the conversation feels.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-400 text-sm">Sounds like a real person, not a robot</p>
                  </div>
                  <div className="text-center p-4">
                    <div className="text-2xl mb-2">📅</div>
                    <h4 className="text-white font-semibold mb-2">Real Booking</h4>
                    <p className="text-gray-400 text-sm">Actually checks availability and books appointments</p>
                  </div>
                  <div className="text-center p-4">
                    <div className="text-2xl mb-2">❓</div>
                    <h4 className="text-white font-semibold mb-2">Answers Questions</h4>
                    <p className="text-gray-400 text-sm">Knows about services, pricing, and policies</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="beesly-container relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-blue-500/20 backdrop-blur-md px-4 py-2 rounded-full mb-6 border border-blue-500/30">
                ...
                <span className="text-blue-300 text-sm font-medium">Calendar integrations</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Works with your existing calendar
              </h2>
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Seamlessly integrates with your current calendar system for real-time appointment booking.
              </p>
            </div>
            
            {/* Calendar Options */}
            <div className="flex justify-center items-center gap-8 flex-wrap">
              <div className="bg-white rounded-2xl p-8 border-2 border-blue-500/30 hover:border-blue-500/60 transition-all duration-300 hover:transform hover:scale-105 shadow-lg">
