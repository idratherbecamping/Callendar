...
const OfficeVoiceDemo = () => {
  ...
  const demo = {
    ...
    audioSrc: "/haircut recording.m4a",
  };
      ...
      <div className="beesly-container relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            This is a real conversation between our AI and an actual customer booking a haircut. 
            Notice how natural and professional the interaction sounds.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="text-center glass-morphism-dark rounded-xl p-6">
            ...
            <h4 className="text-white font-bold mb-2">Perfect for Barbershops</h4>
            <p className="text-gray-400 text-sm">Handles haircuts, styling, treatments</p>
          </div>
          <div className="text-center glass-morphism-dark rounded-xl p-6">
            <div className="text-3xl mb-3">📅</div>
            <h4 className="text-white font-bold mb-2">Real-time Booking</h4>
            <p className="text-gray-400 text-sm">Checks your actual calendar</p>
          </div>
          <div className="text-center glass-morphism-dark rounded-xl p-6">
            <div className="text-3xl mb-3">🤖</div>
            <h4 className="text-white font-bold mb-2">Sounds Human</h4>
            <p className="text-gray-400 text-sm">Professional, natural conversations</p>
          </div>
        </div>
      </div>
    </section>
...
export default OfficeVoiceDemo;